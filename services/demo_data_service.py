...
class DemoDataService:
    ...
    DEMO_CARS = [
        ...
        ("Rolls-Royce", "Phantom", 2024, "LD-RR-003", "Diamond Black", "sedan", "petrol", "automatic", 5, 85000, "available"),
        ("Rolls-Royce", "Spectre", 2024, "LD-RR-004", "Morganite", "sedan", "electric", "automatic", 4, 78000, "available"),
        ("Lamborghini", "Aventador SVJ", 2023, "LD-LAM-03", "Grigio Telesto", "sports", "petrol", "automatic", 2, 70000, "available"),
        ("Lamborghini", "Revuelto", 2024, "LD-LAM-04", "Blu Eleos", "sports", "hybrid", "automatic", 2, 80000, "available"),
        ("Ferrari", "SF90 Stradale", 2023, "LD-FER-03", "Giallo Modena", "sports", "hybrid", "automatic", 2, 72000, "available"),
        ("Ferrari", "F8 Tributo", 2022, "LD-FER-04", "Rosso Scuderia", "sports", "petrol", "automatic", 2, 65000, "available"),
        ("Bentley", "Continental GT Speed", 2024, "LD-BEN-02", "Beluga Black", "sports", "petrol", "automatic", 4, 55000, "available"),
        ("Bentley", "Flying Spur Speed", 2024, "LD-BEN-03", "Silver Tempest", "sedan", "petrol", "automatic", 5, 58000, "available"),
        ("Porsche", "Panamera Turbo E-Hybrid", 2024, "LD-POR-03", "Gentian Blue", "sedan", "hybrid", "automatic", 4, 44000, "available"),
        ("Porsche", "Taycan Turbo S", 2024, "LD-POR-04", "Frozen Berry", "sports", "electric", "automatic", 4, 48000, "available"),
        ("BMW", "X7 M60i", 2024, "LD-BMW-02", "Alpine White", "suv", "petrol", "automatic", 7, 32000, "available"),
        ("BMW", "M8 Competition Gran Coupe", 2023, "LD-BMW-03", "Brooklyn Grey", "sports", "petrol", "automatic", 4, 35000, "available"),
        ("Mercedes-Benz", "AMG GT 63 S E Performance", 2023, "LD-MBZ-02", "Selenite Grey", "sports", "hybrid", "automatic", 4, 40000, "available"),
        ("Mercedes-Benz", "Maybach GLS 600", 2024, "LD-MBZ-03", "Magnetic Black", "suv", "petrol", "automatic", 5, 50000, "available"),
        ("Audi", "RS7 Sportback Performance", 2024, "LD-AUD-02", "Sebring Black", "sedan", "petrol", "automatic", 5, 34000, "available"),
        ("Audi", "Q8 55 TFSI e", 2024, "LD-AUD-03", "Navarra Blue", "suv", "hybrid", "automatic", 5, 30000, "available"),
        ("Aston Martin", "DB12", 2024, "LD-AM-01", "Iridescent Emerald", "sports", "petrol", "automatic", 2, 60000, "available"),
        ("Aston Martin", "DBS Superleggera", 2023, "LD-AM-02", "China Grey", "sports", "petrol", "automatic", 2, 63000, "available"),
        ("McLaren", "720S", 2023, "LD-MCL-01", "Papaya Spark", "sports", "petrol", "automatic", 2, 74000, "available"),
        ("McLaren", "Artura", 2024, "LD-MCL-02", "Aurora Blue", "sports", "hybrid", "automatic", 2, 76000, "available"),
    ]
